...
webhooks_api_definition='webhooks-api-swagger-definition.yaml'
...
webhooks_api_definition_s3="${version}_${current_commit}_${webhooks_api_definition}"
...
aws s3 cp "./doc/serverless/swagger/$webhooks_api_definition" "s3://${S3_LAMBDA_BUCKET}/api/$webhooks_api_definition_s3" --region "$region"
...
export WEBHOOKS_API_DEFINITION="$webhooks_api_definition_s3"
